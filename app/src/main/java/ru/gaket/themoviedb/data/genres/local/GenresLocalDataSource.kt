...
class GenresLocalDataSourceImpl @Inject constructor(
	...
	override suspend fun insertAll(genres: List<GenreEntity>) { genresDao::replaceAll }
	
	override suspend fun deleteAll() { genresDao::deleteAll }
	
	override suspend fun deleteById(id: Int) { genresDao::deleteById }
}